                    ...
                    <tbody>
                        {users && users.map((user)=> (
                            <tr key={user._id} className='text-center'>
                                ...
                                {!user.isAdmin && <td className='border'><button className='bg-blue-500 rounded-md py-1 px-4 mr-4' onClick={()=>navigate(`/admin/users/${user._id}/edit`)}>Edit</button><button className='bg-red-500 rounded-md py-1 px-4' onClick={()=> onDelete(user._id)}>Delete</button></td>}  
                            </tr>
                        ))}
                    </tbody>
                </table>
